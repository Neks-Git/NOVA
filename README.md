...
Heads up: This is my personal project. I'm sharing the code in case it's useful to someone, but I won't be providing support or anything
Why Share This?
Mainly so I have a backup on GitHub. If someone finds somehow and finds it useful, cool. If not, that's fine too
License
...
- Discord Bot Token
- OpenAI API Key
- Tenor API Key (optional, for GIFs)
